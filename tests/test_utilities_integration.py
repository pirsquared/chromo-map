...
class TestUtilitiesIntegration:
    ...
    def test_color_gradient_swatch_consistency(self):
        ...
        assert (
            abs(adjusted_color.hsv[0] - adjusted_swatch.gradients[0].colors[0].hsv[0])
            < 1e-10
        )
    ...
    def test_chained_operations_all_classes(self):
        ...
        color = colors[0]
        chained_color = (
            color.adjust_hue(60).adjust_saturation(0.8).adjust_brightness(0.9)
        )
        ...
        gradient = Gradient(colors, name="Test")
        chained_gradient = (
            gradient.adjust_hue(60).adjust_saturation(0.8).adjust_brightness(0.9)
        )
        ...
        swatch = Swatch([gradient])
        chained_swatch = (
            swatch.adjust_hue(60).adjust_saturation(0.8).adjust_brightness(0.9)
        )
